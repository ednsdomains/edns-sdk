...
interface BaseRegistryFacetInterface extends ethers.utils.Interface {
  functions: {
...
export class BaseRegistryFacet extends BaseContract {
  ...
  interface: BaseRegistryFacetInterface;
