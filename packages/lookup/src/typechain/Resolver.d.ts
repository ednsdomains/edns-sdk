...
export class Resolver extends BaseContract {
  ...
  functions: {
    ...
    multihash(node: BytesLike, overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    multihash(node: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
