...
interface SingletonRegistrarInterface extends ethers.utils.Interface {
  functions: {
...
export class SingletonRegistrar extends BaseContract {
  ...
  interface: SingletonRegistrarInterface;
