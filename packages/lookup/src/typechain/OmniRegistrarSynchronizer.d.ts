...
interface OmniRegistrarSynchronizerInterface extends ethers.utils.Interface {
  functions: {
...
export class OmniRegistrarSynchronizer extends BaseContract {
  ...
  interface: OmniRegistrarSynchronizerInterface;
  ...
  callStatic: {
    ...
    setRegistrar(registrar_: string, overrides?: CallOverrides): Promise<void>;
