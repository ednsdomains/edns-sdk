...
interface IPublicResolverSynchronizerInterface extends ethers.utils.Interface {
  functions: {
...
export class IPublicResolverSynchronizer extends BaseContract {
  ...
  interface: IPublicResolverSynchronizerInterface;
