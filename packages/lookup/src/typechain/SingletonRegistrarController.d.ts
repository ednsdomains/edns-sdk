...
interface SingletonRegistrarControllerInterface extends ethers.utils.Interface {
  functions: {
...
export class SingletonRegistrarController extends BaseContract {
  ...
  interface: SingletonRegistrarControllerInterface;
